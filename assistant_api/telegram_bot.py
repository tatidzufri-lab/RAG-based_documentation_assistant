"""
Telegram бот для RAG-ассистента (API mode).

Бот позволяет пользователям задавать вопросы ассистенту через Telegram
и получать ответы на основе векторного поиска и OpenAI LLM.
"""
...
class TelegramRAGBot:
    ...
    async def start_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        welcome_message = (
            "Добро пожаловать в RAG-ассистент (API mode)!\n\n"
            "Я могу отвечать на ваши вопросы, используя базу знаний "
            "и OpenAI для генерации ответов.\n\n"
            "Доступные команды:\n"
